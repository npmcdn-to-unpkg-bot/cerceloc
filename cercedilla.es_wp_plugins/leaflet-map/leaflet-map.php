...
if (!class_exists('Leaflet_Map_Plugin')) {
    ...
    class Leaflet_Map_Plugin {
        ...
        public function enqueue_and_register () {
            ...
            wp_register_script('leaflet_easybutton_js', plugins_url('scripts/easy-button.js', __FILE__), Array(), $version, true);
            wp_register_style('leaflet_easybutton_stylesheet', plugins_url('easy-button.css', __FILE__), Array(), $version, false);
        ...
        public function admin_init () {
            ...
            wp_register_style('leaflet_easybutton_stylesheet', plugins_url('easy-button.css', __FILE__));
        }
        ...
        public function map_shortcode ( $atts ) {
            ...
            wp_enqueue_style('leaflet_easybutton_stylesheet');
            wp_enqueue_script('leaflet_js');
            wp_enqueue_script('leaflet_easybutton_js');
            ...
            $geojson_script = "<script>
                WPLeafletMapPlugin.add(function () {
                    ...
                    L.easyButton('fa-crosshairs fa-lg', function(btn, map){
                      previous_map.locate({setView: true, maxZoom: 16});
                    }).addTo( previous_map );

                    function onLocationFound(e) {
                      var radius = e.accuracy / 2;

                      L.marker(e.latlng).addTo(previous_map)
                          .bindPopup('You are within ' + radius + ' meters from this point').openPopup();

                      L.circle(e.latlng, radius).addTo(previous_map);
                    }

                    previous_map.on('locationfound', onLocationFound);
